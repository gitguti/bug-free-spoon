...
const Footer = () => {
    return (
        <footer className="bg-white font-sans">
            <div className="pt-12 4xl:pt-24 mx-auto">
                <div className="relative grid gap-x-0 gap-y-3 md:gap-[7px] grid-flow-col grid-cols-1 grid-rows-3  sm:grid-cols-3 md:grid-rows-2 lg:grid-cols-4 px-4 md:px-16">
  ...
  <div className="relative block">
    ...
    />
                    ...
                    <div className='flex sm:items-end pb-3 sm:mb-4 mt-4 md:mb-0 flex-col md:flex-row gap-8 text-sm md:text-base 2xl:text-xl sm:col-start-1 sm:col-span-3 sm:row-start-3 md:row-start-2 place-items-start md:place-items-end lg:pb-4 relative'>
