            ...
            <div className="px-4 md:px-16 pt-12 mx-auto">
                <div className="relative grid gap-8 grid-flow-col grid-cols-1 grid-rows-3  sm:grid-cols-3 md:grid-rows-2 lg:grid-cols-4">
                    <div className="sm:col-start-1 sm:row-start-1 flex flex-col items-center md:items-start">
                        ...
                        <p className="text-new-black text-center md:text-left text-xs md:text-sm mt-4 mx-8 md:mx-0">Transform your bets into unique digital assets and trade on the first and only bet marketplace</p>
                    </div>
                    ...
                    <div className='flex sm:items-end md:items-start flex-col md:flex-row gap-8 text-sm md:text-base sm:col-start-1 sm:col-span-3 sm:row-start-3 md:row-start-2 place-items-start md:place-items-center'>
