    ...
    return (
        <>
            <div className='bg-dirty-grey pt-16 md:pt-20 lg:pt-24 3xl:pt-36 3xl:pt-64 text-center flex flex-col justify-center mx-auto space-between gap-8'>
                <div className='font-tomato mx-auto px-8 text-base md:text-xl 3xl:text-3xl 4xl:text-4xl font-light text-new-black md:max-w-screen-md 2xl:max-w-screen-lg'> <p>For these and many other reasons, we have created<span className='text-gradient'> BetSell</span>, a platform that allows gamblers to sell their bets to other players in a secure and privacy preserving marketplace</p>
                </div>
