...
const Section2 = () => {
  return (
    ...
    <div className="bg-lila px-px sm:px-8 md:px-0 py-16 lg:py-48 mx-auto w-11/12 4xl:w-9/12 4xl:w-9/12">
      <div className="mb-12 xl:mb-16 4xl:mb-20 flex items-center">
        <SwitchHorizontal />
        <p className="pl-4 sm:text-xs md:text-base lg:text-2xl 2xl:text-3xl 4xl:text-4xl text-new-black font-tomato inline-block align-center">Securely trade your bets with other users</p>
      </div>
...
const Card = ({ title, backgroundImage, titleColor }) => {
  const titleClasses = `absolute top-4 left-4 md:top-6 md:left-6 text-xl md:text-base lg:text-2xl 2xl:text-3xl 4xl:text-5xl 2xl:p-8 w-2/3 lg:w-1/2 lg:w-2/3 font-tomato font-normal ${titleColor}`;
