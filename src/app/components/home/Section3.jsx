...
const Card = ({ title, backgroundImage, titleColor }) => {
  const titleClasses = `absolute top-2 left-2 md:top-4 md:left-4 lg:top-8 lg:left-[2.2rem] 3xl:top-16 3xl:left-[2.5rem] 4xl:top-20 4xl:left-14 md:text-xl xl:text-3xl xl:top-12 w-2/3 lg:text-2xl 3xl:text-[2.5rem] 4xl:text-[3.5rem] lg:w-full font-tomato font-medium  ${titleColor}`;
