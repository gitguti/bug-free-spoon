...
const Card = ({ title, backgroundImage, titleColor, delay, isVisible, content, button }) => {
  ...
  const mobileAnimationClass = isVisible
    ...
    const contentClasses = `absolute top-20 lg:top-24 xl:top-28 3xl:top-36 4xl:top-40 left-4 md:left-6 xl:left-[2.2rem] text-xs md:text-sm md:leading-[22px] xl:text-base 3xl:text-xl 4xl:text-[1.75rem] 4xl:leading-[2.1rem] 2xl:p-8 w-3/4 lg:w-1/2 lg:w-2/3 xl:w-3/4 3xl:w-4/5 ${titleColor}`;
