...
return (
        <>
          <div className="w-72 md:w-72 h-80 px-8 md:px-12 py-4 md:py-8 md:h-96 2xl:h-[30rem] max-w-xs md:max-w-md 2xl:max-w-2xl overflow-hidden rounded-xl  bg-white hover:shadow-xl transition-shadow duration-300 ease-in-out  justify-content-start" style={{ backgroundColor: "#492C75" }}>
  ...
  return (
        <>
          <div className="w-96 md:w-[48rem] h-80  px-12 py-10 md:h-96 2xl:h-[30rem] max-w-4xl 2xl:max-w-6xl overflow-hidden rounded-xl bg-cta-app bg-cover  hover:shadow-xl transition-shadow duration-300 ease-in-out">
          </div>
        </>
        )
}
