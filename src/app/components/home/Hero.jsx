      ...
      <Marquee autoFill={true}>
        ...
        <div className="px-px sm:px-8 w-11/12 lg:w-9/12 4xl:w-10/12 mx-auto flex justify-center mt-10 mb-24 2xl:mb-40 2xl:mt-16 4xl:mt-24">
          <div className="text-center mx-auto 4xl:w-9/12">
            <h1 className="font-tomato text-[1.7rem] md:text-[3.25rem] md:leading-[3.6rem] 2xl:text-8xl font-semibold leading-8 2xl:leading-[1.1] mb-[0.6rem] sm:mb-4 text-center text-gradient">Embrace the future of Bet Commerce using NFTs</h1>
