      ...
      <Marquee autoFill={true}>
        ...
        <div className="px-px sm:px-8 w-11/12 3xl:w-10/12 mx-auto flex justify-center mt-10 mb-24 2xl:mb-40 2xl:mt-16 3xl:mt-24">
          <div className="text-center mx-auto 3xl:w-9/12">
            ...
            <p className="text-lg text-new-black mb-8 2xl:text-2xl lg:w-1/3 3xl:w-1/2 mx-auto ">Transform your bets into unique digital assets and trade on the first and only bet marketplace</p>
