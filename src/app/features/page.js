...
<div className="flex items-center text-center justify-center mb-6 md:mb-8 xl:mb-12 3xl:mb-10 4xl:mb-20 ">
        <Charts />
        <p className="pl-2  sm:text-xs md:text-base lg:text-xl xl:text-[1.8rem] 3x:text-[2.3rem] 4xl:text-[2.5rem] text-new-black font-tomato inline-block align-center">Adding value to your betting assets</p>
      </div>
